        ...
        >
            <SafeAreaView className="flex-1" edges={['top', 'left', 'right']}>
                ...
                <View className="flex-1 mt-8 items-center px-8">
                    {/* <Ionicons name="wifi-outline" size={64} color="#fff" /> */}
                    <Text className="text-white text-xl font-poppins-semibold text-center mt-4 mb-2">
                        No Internet Connection
                    </Text>
                    <Text className="text-white text-base font-poppins-regular text-center opacity-80">
